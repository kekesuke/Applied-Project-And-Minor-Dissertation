...
class FitnessBuddy : AppCompatActivity(),  OnMapReadyCallback {
...
//        val sydney = LatLng(53.2707, -9.0568)
//        mMap.addMarker(MarkerOptions().position(sydney).title("Marker in Galway").icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_GREEN)))
